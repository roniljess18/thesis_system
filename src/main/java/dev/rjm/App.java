...
public class App extends FXApplication {
   ...
   public static final FXControllerRegister CONTROLLER_REGISTER = FXControllerRegister.INSTANCE;
    ...
    public static final DBService DB_THESIS = DBService.INSTANCE
            .initialize("jdbc:mysql://localhost:3300/eyyyy?user=root&passwords=");

    @Override
    public void initialize() throws Exception {
        setTitle("Thesis Management");
        //setSkin(FXSkin.CUSTOM);
    ...
    private void _initialize_dataset() {
        //COLLECTIONS_REGISTER.register("TBLTHESISRESEARCHER", FXCollections.observableArrayList(TBLThesisResearcherDAO.getTBLThesisResearcherList()));
        COLLECTIONS_REGISTER.register("TBLSTUDENTS", FXCollections.observableArrayList(TBLStudentDAO.getTBLStudentList()));
        COLLECTIONS_REGISTER.register("DEGREE", FXCollections.observableArrayList(DegreeDAO.getDegreeList()));
        COLLECTIONS_REGISTER.register("TBLTHESIS", FXCollections.observableArrayList(TBLThesisDAO.getTBLThesisList()));
